...
function Navbar() {
  ...
  return (
    <div className={`flex fixed w-full border-b md:border-none ${active ? ' bg-black/45 backdrop-blur-sm text-white ':' '} px-4 md:px-8 bg-dark z-50 justify-between items-center py-2`}>
        <div>
