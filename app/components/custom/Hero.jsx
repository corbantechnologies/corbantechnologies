...
function Hero() {
  return (
    ...
    <div className="bg-slate-100 mt-10 mb-10 md:mb-20 py-10 px-4 md:px-10 rounded-xl max-w-screen-lg mx-4 md:mx-auto">
      ...
      <ul className="flex flex-wrap justify-center items-center gap-8">
        ...
        <li>
          <img src="/dukalogo.jpg" alt="nafsi reset logo" className="max-w-28"/>
        </li>
