...
function Hero() {
  return (
    ...
    <div className="pt-[75px] px-4 lg:px-8 min-h-screen place-content-center md:mb-0 max-w-[1200px] mx-auto">
      <div className="grid gap-5 grid-cols-1 lg:grid-cols-2 items-center">
        <div>
          ...
          <div className="flex max-w-[320px] md:max-w-[500px] mx-auto justify-center mb-10 md:mb-0">
    ...
    <div className="bg-slate-50 mt-10 mb-10 md:mb-20 py-10 px-4 md:px-10 rounded-xl max-w-screen-lg mx-4 md:mx-auto">
      <p className="text-center leading-relaxed text-secondaryBlue font-semibold text-2xl mb-16 mx-auto">
      We empower some of Africa&apos;s best startups <span className="text-primary">with our innovative and scalable software solutions.</span>
      </p>
      <ul className="flex flex-wrap justify-center items-center gap-8">
        <li>
          <img src="/nafsiresetlogo.png" alt="nafsi reset logo" className="max-w-28 md:max-w-32"/>
        </li>
        <li className='text-2xl md:text-3xl font-bold'>StayHub</li>
        <li>
          <img src="/dukalogo.png" alt="nafsi reset logo" className="max-w-24 md:max-w-28"/>
        </li>
        <li>
          <img src="/suppcologo.png" alt="nafsi reset logo" className="max-w-24 md:max-w-28"/>
        </li>
        <li className='text-2xl md:first-letter:text-3xl text-green-700 font-bold'>AgriBooks</li>
      </ul>
    </div>
    </div>
  );
