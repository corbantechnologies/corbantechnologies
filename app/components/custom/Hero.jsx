  ...
  return (
    <div className='pt-[75px] px-0 md:px-8'>        
              <div className="md:heroBg h-screen text-black md:text-white relative md:rounded-lg overflow-hidden">
                ...
                <div className="absolute md:pt-[100px] h-[100vh] grid place-content-center left-2 right-2 md:left-8">
                  ...
                  <h1 className="text-3xl md:text-5xl font-semibold md:font-bold text-center md:text-left max-w-[500px] md:tracking-wide">Empowering lives through innovation & technology.</h1>
                  <p className="md:max-w-[500px] text-center md:text-left my-5 md:my-8 text-base md:text-[20px]">Your one-stop digital software solutions company. At Corban Technologies, we thrive on transforming your ideas into cutting-edge digital realities.</p>
                  <div className="flex flex-col md:flex-row gap-3 md:gap-5">
                    <button className="bg-primary text-white font-semibold px-4 py-3 rounded-full">Start a Project</button>
                    <button className="border font-semibold px-4 py-3 rounded-full">Get a Quote</button>
                  </div>
