    ...
    <div className='pt-[75px] px-0 md:px-8'>        
              <div className="md:heroBg h-screen text-black md:text-white relative md:rounded-lg overflow-hidden">
                ...
                <div className="absolute md:pt-[100px] -top-5 md:top-0 h-[100vh] grid place-content-center left-4 right-4 md:left-8">
                  ...
                  <h1 className="text-3xl md:text-5xl font-semibold md:font-bold text-center md:text-left mx-auto md:mx-0 max-w-[300px] md:max-w-[500px] md:tracking-wide">Empowering lives through innovation & technology.</h1>
                  <p className="max-w-[300px] mx-auto md:mx-0 md:max-w-[500px] text-center md:text-left my-5 md:my-8 text-base md:text-[20px]">Your one-stop digital software solutions company. At Corban Technologies, we thrive on transforming your ideas into cutting-edge digital realities.</p>
